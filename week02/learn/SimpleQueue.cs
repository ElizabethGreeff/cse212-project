public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: Could not find index number, as the Dequeue was trying to remove from index 1 rather than 0.
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Attempting to add to the front of the queue rather than the end.
        ...
        // Defect(s) Found: None, all clear here.
    }
